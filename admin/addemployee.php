...
$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status,sl,el,cl) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status,:sl,:el,:cl)";
...
<input id="sl" name="sl" type="hidden" value="12">
<input id="el" name="el" type="hidden" value="12">
<input id="cl" name="cl" type="hidden" value="12">
